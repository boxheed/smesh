...
@JsonPropertyOrder({ "id", "in", "out", "ip", "name" })
public class Span implements Serializable {

    private static final long serialVersionUID = 5388543041777497840L;
     ...
     * In Date Time
     * <p>
     * The date time for the start of the span formatted as an ISO 8601 date time
     * string
     * 
     */
    @JsonProperty("in")
     ...
     * Out Date Time
     * <p>
     * The date time for the end of the span formatted as an ISO 8601 date time
     * string
     * 
     */
    @JsonProperty("out")
