...
@JsonPropertyOrder({ "id", "recipient", "sender", "meta", "headers", "payload" })
public class Parcel implements Serializable {
     ...
     * Meta Information
     * <p>
     * Container for meta data information about the request (Required)
     * 
     */
    @JsonProperty("meta")
    ...
    public String toString() {
        return "Parcel [id=" + id + ", recipient=" + recipient + ", sender=" + sender + ", meta=" + meta + ", headers="
